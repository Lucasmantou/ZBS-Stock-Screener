...
description: 智能选股+个股深度研究系统（GitHub开源版），提供6种选股策略和三层架构分析（数据采集+AI分析+HTML生成），基于AkShare免费数据。当用户说"分析XXX股票"或"选股/推荐股票"时触发。
...
> 版本：v2.3 | 更新：2026-05-18 | 定位：选股推荐 + 三层架构分析 + AI手写HTML
